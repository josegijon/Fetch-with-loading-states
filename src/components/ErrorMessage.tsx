    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center gap-5 w-full">
            ...
            {onRetry && (
                <button
                    onClick={onRetry}
                    className="flex flex-1 max-w-50 items-center justify-center gap-2 rounded-xl px-8 py-3 bg-slate-800 text-slate-200 text-sm font-bold transition-all ease-in-out duration-300 cursor-pointer
                hover:bg-slate-700 ">
